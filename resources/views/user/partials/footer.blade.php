<footer class="bg-gray-900 text-gray-300">
    ...
    <div class="container max-w-screen-xl mx-auto px-4 py-12 md:py-16">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 md:gap-12">
            ...
            <!-- Contact Column -->
            <div class="col-span-2 md:col-span-1">
                <h3 class="text-lg font-bold font-montserrat text-white mb-4 pb-2 border-b border-gray-700">Contact Us
                </h3>
                <div class="grid grid-cols-1 gap-8">
                    <ul class="space-y-3">
        ...
        <div class="container max-w-screen-xl mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div class="text-gray-500 text-sm text-center md:text-left">
                    &copy; {{ date('Y') }} Cloud Care Host. All Rights Reserved.
                </div>
                ...
                <div class="flex gap-3 text-gray-400 text-xl">
                    ...
                    <i class="fab fa-bitcoin hover:text-white transition-colors"></i>
                </div>
            </div>
        </div>
    </div>
